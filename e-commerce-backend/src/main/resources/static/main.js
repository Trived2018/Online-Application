...
module.exports = __webpack_require__(/*! C:\Users\pesar\OneDrive\Documents\projectss\Youtube\Online-Application\e-commerce-frontend-ui\src\main.ts */"zUnb");
...
class RegisterComponent {
    ...
    sendOtp() {
        ...
        this.otpService.sendOtp(this.phoneNumber).subscribe((response) => {
            ...
            this.errorMessage = ((_a = error === null || error === void 0 ? void 0 : error.error) === null || _a === void 0 ? void 0 : _a.message) || 'You have already registered with this mobile number. Please try a new number.';
            this.successMessage = '';
            this.isLoadingSendOtp = false;
        });
    }
...
class OtpService {
    constructor(httpClient) {
        ...
        this.PATH_OF_API = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl;
    ...
    sendOtp(phoneNumber) {
        ...
        return this.httpClient.post(this.PATH_OF_API + '/otp/send', request, { headers: this.requestHeader });
    }
    verifyOtp(phoneNumber, code) {
        const request = { phoneNumber: phoneNumber, code: code };
        return this.httpClient.post(this.PATH_OF_API + '/otp/verify', request, { headers: this.requestHeader });
    }
}
...
class ForgotPasswordService {
    ...
    initiatePasswordReset(phoneNumber) {
        const request = { phoneNumber: phoneNumber };
        return this.httpClient.post(this.PATH_OF_API + '/forgot-password/initiate', request, { headers: this.requestHeader });
    }
    verifyOtpForReset(phoneNumber, code) {
        const request = { phoneNumber: phoneNumber, code: code };
        return this.httpClient.post(this.PATH_OF_API + '/forgot-password/verify', request, { headers: this.requestHeader });
    }
    resetPassword(phoneNumber, newPassword, confirmPassword) {
        ...
        return this.httpClient.post(this.PATH_OF_API + '/forgot-password/reset', request, { headers: this.requestHeader });
    }
}
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](UserService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"] }, { type: _user_auth_service__WEBPACK_IMPORTED_MODULE_3__["UserAuthService"] }]; }, null); })();
